...
class CrossDecoder(nn.Module):
    ...
    def forward(self, decoder_input,k_input, padding_mask, decoder_pos_vec):
        # decoder_input: BS X D X T 
        # k_input: BS X D X T style motion 
        # padding_mask: BS X 1 X T
        # decoder_pos_vec: BS X 1 X T
        # obj_embedding: BS X 1 X D
        ...
        style_embedding = self.start_conv(k_input)  # BS X D X T
        style_embedding = style_embedding.transpose(1, 2) # BS X T X D
        ...
        dec_output = new_input_embedding + pos_embedding # BS X T X D
        dec_style = style_embedding+pos_embedding
